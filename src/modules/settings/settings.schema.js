...
const settingsSchema = z.object({
  ...
  whatsappVerifyToken: z.string().optional().default(""),
  whatsappFollowupTemplate: z.string().optional().default(""),
  whatsappMeetingTemplate: z.string().optional().default(""),
  hunterApiKey: z.string().optional().default(""),
  outreachLanguage: z.enum(["auto", "en", "hi"]).optional().default("auto"),
